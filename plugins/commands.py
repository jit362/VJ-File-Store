...
# Ask Doubt on telegram @KingVJ01
    ...
    if data.split("-", 1)[0] == "verify":
        ...
        try:
            if not await check_verification(client, message.from_user.id) and VERIFY_MODE == True:
                btn = [[
                    ...
                    InlineKeyboardButton("🤔 How To Open Link & Verify ✅️", url=VERIFY_TUTORIAL)
                ]]
                await message.reply_text(
                    text="<b>❌️ You are not verified ❕️\nKindly verify to continue ! 👇</b>",
                    protect_content=True,
        ...
        if AUTO_DELETE_MODE == True:
            k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️➖️ IMPORTANT ➖️❗️️❗️❗️</u></b>\n\nThis Movie File/Video will be deleted in <b><u>{AUTO_DELETE} minutes</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>🔥 Please forward this File/Video to your Saved Messages and Start Download there. ✅️</b>")
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        if not await check_verification(client, message.from_user.id) and VERIFY_MODE == True:
            btn = [[
                InlineKeyboardButton("❤️‍🔥➖️➖️ Verify Now ➖️➖️❤️‍🔥", url=await get_token(client, message.from_user.id, f"https://telegram.me/{username}?start="))
            ],[
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[
            InlineKeyboardButton('😊 Join Official Channel', url='https://telegram.me/sgu4tech')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/sgu_tutorials'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/sgu4tech')
            ],[
